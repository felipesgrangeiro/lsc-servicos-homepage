...
/** Marcas do Grupo TB no rodape (sem a LSC — ja destacada no brand) */
const ecosystemBrands = [
  {
    name: "TB Transportes",
    href: "https://www.tbtransportes.srv.br/",
    logo: "/images/logo-tb-transportes.png",
    logoAlt: "TB Transportes",
    className: "footerBrandTb",
  },
  {
    name: "TMC Terminais",
    href: "https://tmcterminais.com.br/",
    logo: "/images/logo-tmc.png",
    logoAlt: "TMC Terminais",
    className: "footerBrandTmc",
  },
  {
    name: "Truck Center Pecém",
    href: "https://grupotbhub.com.br/tcp-truck-center/",
    logo: "/images/logo-truck-center.png",
    logoAlt: "Truck Center Pecém",
    className: "footerBrandTruck",
  },
];
      ...
      <div className="shell footerGrid">
        ...
        <div className="footerCompanies">
          ...
          <nav aria-label="Empresas do Grupo TB">
            {/* Tres copias: looping continuo sem salto */}
            <div className="footerCompanyTrack">
              {[...ecosystemBrands, ...ecosystemBrands, ...ecosystemBrands].map((c, i) => {
                const copia = i >= ecosystemBrands.length;
                return (
                  <a
                    key={`${c.name}-${i}`}
        ...
        <div className="contact">
          <b>Contato</b>
          <a href="tel:+5585991481961"><Phone /> (85) 99148-1961</a>
          <a
            href="https://wa.me/5585991771977"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="WhatsApp: (85) 99177-1977"
          >
            <svg className="footerWhatsappIcon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
